      ...
      <div className="container pad-top">
        <div className="card text-white bg-dark" style={{maxWidth:'600px',margin:'0 auto'}}>
          ...
          <div className="card-body">
            <div style={{ display: (this.state.hasRoomOptions ? 'none' : 'flex') }} className="loading">
            ...
            <button className="btn btn-lg btn-success btn-block" onClick={this.createRoom}>Create</button>
          </div>
        </div>
      </div>
    );
